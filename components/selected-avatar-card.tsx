...
// scrolls. `sticky` pins it to the bottom of its scroll container with a
// fade above; otherwise it's a plain inline card. Cross-fades when you
...
export function SelectedAvatarCard({
  ...
  return (
    <div
      className={
        sticky
          ? "sticky bottom-0 z-10 -mx-5 px-5 pt-4 pb-1 bg-gradient-to-t from-dark-blue-900 from-65% via-dark-blue-900 to-transparent"
          : ""
      }
    >
