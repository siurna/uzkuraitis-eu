    ...
    <>
      ...
      <div className="fixed bottom-20 left-0 right-0 z-30 flex justify-center pointer-events-none">
        <motion.div
          ...
          className="pointer-events-auto glass-card rounded-full px-2 py-1 flex gap-1 shadow-glow-pink"
        >
          {EMOJIS.map((e) => (
            <motion.button
              key={e}
              ...
              className="h-10 w-10 grid place-items-center rounded-full hover:bg-white/10 text-2xl"
