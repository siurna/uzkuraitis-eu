...
const S = {
  ...
  rules_top10_b:     { en: "Only countries that finish in the official Top 10 score anything.\n\nPlace one in the exact spot it finished and you bank its full Eurovision points (12, 10, 8…1).\n\nOff by a place? Slide one rung down the scoreboard: a country that came 1st but you ranked 3rd scores 8 (3rd place's value), and sliding past 10th means 0.", lt: "Taškus skiria tik šalys, patekusios į oficialų TOP 10.\n\nŠalis, pastatyta tiksliai į jos užimtą vietą, surenka pilnus Eurovizijos taškus (12, 10, 8…1).\n\nKlysti viena vieta? Nuslysti viena pakopa žemyn lentelėje: jei šalis liko 1-a, o tu ją pastatei 3-ią, gauni 8 (3-ios vietos vertę). Nuslydęs už 10-os negausi nieko." },
  ...
  rules_home_b:      { en: "Guess where {home} finishes.\n\nNail it and that's 12 points; every place you're off slides you one rung down the Eurovision ladder (12 → 10 → 8 → 7 … 1):", lt: "Atspėk, kelintas liks {home}.\n\nPataikei tiksliai, 12 taškų; už kiekvieną netaiklią vietą nuslysti pakopa žemyn Eurovizijos skale (12 → 10 → 8 → 7 … 1):" },
