...
export const TROPES_EN = [
  ...
  "🪑 Burning confessional + flying chairs",
  ...
  "🎭 Lion Ceccah's hooded cloak reveal",
...
export const TROPES_LT = [
  ...
  "🪑 Degantis konfesionalas ir kylančios kėdės",
  "💒 Italija scenoje surengia vestuves",
  "🍋 Citrinmedžiai ir girliandos Sal Da Vinciui",
  "🌙 Delta Goodrem: mėnulis virsta saule ir pyro",
  "💎 500 valandų Swarovski suknelė",
  "🪑 Didžiulis stalas su šokėjais",
  "💻 Vyrukas su biuro kolegom - monitorinėm galvom",
  "🎹 Rankomis sukonstruotų sintezatorių siena",
  ...
  "🎯 Felicia „kaunasi su lazeriais“",
  "📦 Danijos spalvas keičianti dėžė",
  "🎬 Maltos zoetrope`as pradeda suktis",
  ...
  "🎶 Prancūzija pereina į pilną chanson + tono pakėlimas",
  "🟦 Vokietija pasiūlo keistą dainos koncepciją",
  ...
  "💃 Victoria Swarovski vėl pakeičia suknelę",
  "😬 Ostrowskio pokštas nesuveikia nei viena kalba",
  "🎼 JJ atidaro vakarą su Mozartu ir 40 šokėjų",
  "🪗 Verka Serduchka pavogia mūsų širdis",
  "🎺 Niekieno nekviesti pasirodo Lordi",
  "🎶 Kažkas užtraukia „Vienna“ prieš rezultatus",
  "📞 Vedantieji dar kartą primena balsuoti",
  "🥇 Suomijos šansai subliūkšta per žiūrovų balsavimą",
  ...
  "🎻 Tradinis niekur nematytas instrumentas",
  "🏳️‍🌈 Vaivorykštinė vėliava minioje",
  "🌑 Šviesos nukerta į siluetą",
  "🪞 „Veidrodinė“ choreografija",
  "💪 Šokėjas be marškinių (ir be aiškios priežasties)",
  "🪜 Atlikėjas didingai leidžiasi nuo laiptų",
  "🎆 Konfeti patrankos",
  "🦋 Netikėtas kostiumo atskleidimas viduryje dainos",
  "🤸 Šokėjas atlieka salto",
  "🔦 Prožektorius → tamsa → visa scena",
  ...
  "🫀 Atlikėjas prispaudžia ranką prie krūtinės ir užsimerkia",
  "🔁 Paskutinės 20s: tono pakėlimas IR ilga aukšta nata",
  "💍 Tekstas: meilė nugali absoliučiai viską",
  "🍾 Tekstas: šėlsim iki ryto",
  "🕊️ Forsuota eilutė apie „pasaulio taiką“",
  "🌍 „Ačiū, Europa“ penkiomis kalbomis",
  "🪩 Diskobolas",
  "📺 LED siena = atlikėjo veidas (tik 10m aukščio)",
  "🐺 Kažkas pasirodo su gyvūno kauke",
  "🪂 Nusileidžia akrobatai ir/ar oro audeklai",
  "🛼 Riedučiai (visiškai be priežasties)",
  "✋ Minia ploja kartu — truputį ne į taktą",
  "💇 Tobulai sinchronizuotas plaukų atmetimas",
  "🚶 Sulėtintas ėjimas link kameros",
  "⏸️ Dramatiška pauzė prieš ritmo kaitą / priedanį",
  "🛏️ Atlikėjas atsigula ant scenos per bridžą",
  "🎸 Gitaros solo",
  "🦵 Poza „ant vieno kelio, ranka ištiesta“",
  "🎶 „Na na na“ / „la la la“ kabliukas",
  "✨ Pilnas camp`as: blizgučiai, apsiaustai, viskas",
  "😬 Vedančių pliurpalai suvalgo 90 nejaukių sekundžių",
  "🤝 Netikėtas duetas ar svečias",
  "🥶 Rūkas iki atlikėjo kelių",
  "🪞 Du veidrodiškai sutampantys atlikėjai... ar jie dvyniai!?",
  "🛸 Keista, mokslinės fantastikos scenografija",
